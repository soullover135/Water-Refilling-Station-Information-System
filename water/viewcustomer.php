...
<body>
	...
	<div class="container">
	<form>
		<button type="submit" name="cancel" class="btn btn-light"><a href="addcustomer.php">Add Customer</a></button>
			<br/><br/>
		<table class="table table-hover">
		  ...
		  <tbody>
			...
			<tr>
			  ...
			  <td><a href="includes/deletecustomer.inc.php?id=<?php echo $row["customer_no"]; ?>">Edit </a><a href="includes/deletecustomer.inc.php?id=<?php echo $row["customer_no"]; ?>"> Delete</a></td>
			</tr>
			<?php		}

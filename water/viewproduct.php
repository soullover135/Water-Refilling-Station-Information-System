...
<body>
	...
	<div class="container">
	<form>
		<button type="submit" name="cancel" class="btn btn-light"><a href="addproduct.php">Add Product</a></button>
			<br/><br/>
		<table class="table table-hover">
		  ...
		  <tbody>
			...
			<tr>
			  ...
			  <td><a href="includes/deleteproduct.inc.php?id=<?php echo $row["product_id"]; ?>">Edit </a><a href="includes/deleteproduct.inc.php?id=<?php echo $row["product_id"]; ?>"> Delete</a></td>
			</tr>
			<?php		}
